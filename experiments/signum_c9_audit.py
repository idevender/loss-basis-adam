...
Audits signum, the one coordinate-wise method that recovers at long horizons:
  P1 is its windowed displacement rank-1 dominated? (falsification test)
  P2 is the fail-at-2e4 / work-at-4e4 boundary a schedule-shape artifact?
  P3 does the long-anneal recovery survive spectral tails?
"""
