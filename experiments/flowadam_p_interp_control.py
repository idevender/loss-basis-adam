...
Runs the selected config to 120k steps, recording (train, recovery, effective rank) at
checkpoints, so the result can be stated at the strict 1e-7 bar rather than a shallower fit.
"""
import sys, os, time
import numpy as np
import torch
